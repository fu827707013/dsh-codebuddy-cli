import { S as parseCodeBuddyAuth, _ as CODEBUDDY_AUTH_FILE_ENV, a as processStartTimeMs, b as defaultAuthDir, d as normalizeCredits, f as prepareChatBody, g as CODEBUDDY_AUTH_FILENAME, h as FALLBACK_CODEBUDDY_MODELS, i as isHeartbeatProcessAlive, l as CodeBuddyUpstreamClient, m as CodeBuddyCatalog, n as clearHostHeartbeat, o as readHostHeartbeat, p as regionOf, r as codebuddyHostHeartbeatPath, s as writeHostHeartbeat, t as CODEBUDDY_HOST_HEARTBEAT_FILENAME, u as classifyUpstreamError, v as CodeBuddyCredentialStore, x as defaultAuthDirCandidates, y as codebuddyOwnAuthPath } from "./host-heartbeat-BrO5neu7.js";
...
function createCodeBuddyAdapter(options) {
	...
	return {
		adapter: new CodeBuddyPiAiAdapter(catalog, {
			profiles: () => profiles,
			auth: INERT_AUTH,
...
*/
async function codeBuddyWebStatus(deps) {
...
function codeBuddyStatusHandler(deps) {
...
const Config = z.object({ authFile: z.string().description("CodeBuddy CLI auth file (defaults to the CLI's own location)") });
/**
