import { A as parseCodeBuddyAuth, C as filterEnabledModels, D as codebuddyOwnAuthPath, E as CodeBuddyCredentialStore, O as defaultAuthDir, S as FALLBACK_CODEBUDDY_MODELS, T as CODEBUDDY_AUTH_FILE_ENV, _ as clientIdentityHeaders, a as processStartTimeMs, b as userAgentFor, d as normalizeCredits, f as prepareChatBody, g as CODEBUDDY_UNKNOWN_VERSION, h as CODEBUDDY_IDE_TYPE, i as isHeartbeatProcessAlive, k as defaultAuthDirCandidates, l as CodeBuddyUpstreamClient, m as CODEBUDDY_IDE_NAME, n as clearHostHeartbeat, o as readHostHeartbeat, p as regionOf, r as codebuddyHostHeartbeatPath, s as writeHostHeartbeat, t as CODEBUDDY_HOST_HEARTBEAT_FILENAME, u as classifyUpstreamError, v as resolveClientIdentity, w as CODEBUDDY_AUTH_FILENAME, x as CodeBuddyCatalog, y as resolveCodeBuddyCliVersion } from "./host-heartbeat-DQ5loECn.js";
...
function codeBuddyCheckInHandler(deps) {
	return async (req, res) => {
		...
		try {
			...
			json(res, 200, await deps.checkIn(credential));
		} catch (error) {
			json(res, 500, { error: safeMessage(error) });
		}
	};
