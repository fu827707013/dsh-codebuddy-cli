	...
	factory: (require) => {
		...
		*/
		...
		function CodeBuddyPluginCard({ t }) {
			...
			const [checkInOutcome, setCheckInOutcome] = (0, react.useState)(void 0);
			...
			*/
			...
			const checkInNote = () => {
				if (checkInOutcome === void 0) return null;
				if (checkInOutcome.status === "ok") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: CodeBuddyPluginCard_module_css_default.bodyText,
					style: { margin: 0 },
					children: checkInOutcome.message === "" ? t("checkInSuccess") : `${t("checkInSuccess")} — ${checkInOutcome.message}`
				});
				if (checkInOutcome.status === "already") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: CodeBuddyPluginCard_module_css_default.bodyText,
					style: { margin: 0 },
					children: t("checkInAlready")
				});
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: CodeBuddyPluginCard_module_css_default.bodyError,
					style: { margin: 0 },
					children: t("checkInFailed", { message: checkInOutcome.message })
				});
			};
			const title = t("title");
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [status.status === "signed-in" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: CodeBuddyPluginCard_module_css_default.refresh,
										disabled: checkingIn,
										onClick: () => {
										...
										children: checkingIn ? t("checkingIn") : t("checkIn")
