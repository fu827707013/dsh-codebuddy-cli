	...
	factory: (require) => {
		...
		*/
		...
		function AccountCards({ accounts, onChanged, t }) {
			...
			const [importState, setImportState] = (0, react.useState)({ phase: "idle" });
			const [importRefresh, setImportRefresh] = (0, react.useState)("");
			const [importAccess, setImportAccess] = (0, react.useState)("");
			const [importDomain, setImportDomain] = (0, react.useState)("cn");
			const mounted = (0, react.useRef)(true);
			(0, react.useEffect)(() => {
				mounted.current = true;
				return () => {
			...
			*/
			const submitImport = async () => {
				...
				if (refreshToken === "") {
					setImportState({
						phase: "done",
						error: t("accountImportNeedRefresh")
					});
					return;
				}
				...
				try {
					...
					if (!body.ok) {
						setImportState({
							phase: "done",
							error: t("accountImportFailed", { message: body.error ?? `HTTP ${response.status}` })
						});
						return;
					}
					...
					setImportState({
						phase: "done",
						error: t("accountImportFailed", { message: cause instanceof Error ? cause.message : t("requestFailed") })
					});
				}
			};
				...
				importOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: t("accountImportRefreshLabel")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
							value: importRefresh,
							onChange: (event) => {
								setImportRefresh(event.target.value);
							},
							rows: 3,
							spellCheck: false,
							autoComplete: "off",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: t("accountImportAccessLabel")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
							value: importAccess,
							onChange: (event) => {
								setImportAccess(event.target.value);
							},
							rows: 3,
							spellCheck: false,
							autoComplete: "off",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							children: t("accountImportDomainLabel")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
							value: importDomain,
							onChange: (event) => {
								setImportDomain(event.target.value === "global" ? "global" : "cn");
							},
							disabled: importState.phase === "busy",
							style: {
								marginTop: 4,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: "cn",
								children: t("accountImportDomainCn")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: "global",
								children: t("accountImportDomainGlobal")
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: importState.phase === "busy" ? t("accountImportSubmitting") : t("accountImportSubmit")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: CodeBuddyPluginCard_module_css_default.refresh,
								disabled: importState.phase === "busy",
								...
								children: t("accountImportCancel")
							})]
						}),
						importState.phase === "busy" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: CodeBuddyPluginCard_module_css_default.bodyText,
							style: { marginTop: 6 },
							children: t("accountImportWorking")
						}) : null,
						importState.phase === "done" && importState.error !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: CodeBuddyPluginCard_module_css_default.bodyError,
							style: { marginTop: 6 },
							children: importState.error
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: CodeBuddyPluginCard_module_css_default.bodyText,
							style: {
							...
							children: t("accountImportStoredNote")
						})
					]
				}) : null,
		...
		function CodeBuddyPluginCard({ t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutlineRegular, { className: open ? cx(CodeBuddyPluginCard_module_css_default.chevron, CodeBuddyPluginCard_module_css_default.chevronOpen) : cx(CodeBuddyPluginCard_module_css_default.chevron) })]
		...
		*/
		function apply(ctx) {
			try {
				...
				ctx.slots.inject.bind(ctx.slots)(legacySlot, () => ctx.slots.register({
					name: legacySlot,
					id: "codebuddy-cli",
					order: 30,
					locale: namespace,
