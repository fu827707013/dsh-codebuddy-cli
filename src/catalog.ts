/**
 * CodeBuddy model catalog: a static fallback list captured from the live
 * endpoint, replaced by the upstream's dynamic answer once it loads.
 *
 * @module dsh-codebuddy-cli/catalog
 */

import type { CodeBuddyUpstreamModel } from './upstream.ts'

/** One model entry the adapter exposes. */
export type CodeBuddyModelInfo = CodeBuddyUpstreamModel
...
export class CodeBuddyCatalog {
  private models: readonly CodeBuddyModelInfo[] = FALLBACK_CODEBUDDY_MODELS
